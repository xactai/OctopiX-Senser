...
public class Whisper {
    ...
    public static String MSG_PROCESSING_DONE = "Processing done...!";
    ...
    private void transcribeFileLoop() {
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                ...
                long timeTaken = transcribeFile();
//                MainActivity.updateInferenceTime(String.valueOf((timeTaken)));
//                Toast.makeText(this.mainActivity,
//                        "Inference Time: " + String.valueOf(timeTaken),
...
//                            result = mWhisperEngine.getTranslation(mWavFilePath);
                    ...
                    String strtimeTaken = "Time Taken for transcription: " + timeTaken + "msecs";
                    Log.d(TAG, strtimeTaken);
                    sendUpdate(MSG_PROCESSING_DONE + "      " + strtimeTaken + "    Inference Time: " + inferenceTime);
                } else {
