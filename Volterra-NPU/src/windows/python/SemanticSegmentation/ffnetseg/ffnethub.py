...
class HubFFnetSeg:
    ...
    def segment_objects(self, image):
        ...
        print(f"{BgColor.GREEN}Inference time: {(inference_end - inference_start)*1000:.5f} msecs{BgColor.OFF}")
        ...
        print(f"Post Processing time: {(end - start)*1000:.5f} msecs")
        print(f"{BgColor.GREEN}End-to-End Prediction time: {(end - inference_start)*1000:.5f} msecs{BgColor.OFF}")
        return final
