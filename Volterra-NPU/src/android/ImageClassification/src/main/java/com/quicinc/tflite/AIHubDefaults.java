...
import com.quicinc.imageclassification.ImageClassification;
...
//             AI Hub sets some GPUv2 settings that are not accessible via the Java API.
    ...
    public static final TFLiteHelpers.DelegateType[][] delegateGpuSelect = new TFLiteHelpers.DelegateType[][] {
            // 1. GPUv2 + XNNPack
            // https://app.aihub.qualcomm.com/docs/hub/api.html#profile-inference-options
            // Similar to AI Hub "compute_unit=gpu" on all devices
            // AI Hub sets some GPU settings that are not accessible via the Java API.
    ...
    public static final TFLiteHelpers.DelegateType[][] delegateNpuSelect = new TFLiteHelpers.DelegateType[][] {
            // 1. GPUv2 + XNNPack
            // https://app.aihub.qualcomm.com/docs/hub/api.html#profile-inference-options
            // Similar to AI Hub "compute_unit=gpu" on all devices
            // AI Hub sets some GPU settings that are not accessible via the Java API.
